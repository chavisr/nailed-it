...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-gruvbox-bg1 text-white">
      <div className={`w-64 bg-gruvbox-bg2 flex flex-col ${cropMode || deleteConfirmation ? 'pointer-events-none opacity-50' : ''}`} onMouseDown={(e) => {
        ...
        <div className="p-4 overflow-y-auto flex-1">
          ...
          <p className="text-sm text-gruvbox-fg mb-6">
            Thumbnail Editor
          </p>
          ...
          {layers.length === 0 ? (
            <div className="text-center py-8 px-4">
              <p className="text-gruvbox-fg text-sm mb-2">No layers yet</p>
              <p className="text-gruvbox-gray text-xs">Add an image or text to get started</p>
            </div>
          ) : (
            <>
            ...
            return (
              <div key={layer.id} className="relative">
                ...
                <div
                  ...
                  className={`p-2 bg-gruvbox-bg3 rounded flex items-center gap-2 cursor-move ${
        ...
        <div className="p-4 border-t border-gruvbox-bg4">
          <a 
            href="https://github.com/chavisr/nailed-it"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-gruvbox-fg hover:text-white transition-colors text-sm"
      ...
      <div className="flex-1 flex flex-col bg-gruvbox-bg0">
        <div className="p-4 bg-gruvbox-bg2 flex items-center gap-4 border-b border-gruvbox-bg4" onMouseDown={(e) => {
          if (e.target === e.currentTarget && !cropMode && !deleteConfirmation) {
            setSelectedLayer(null);
          }
        }}>
          <div className={`flex items-center gap-2 ${cropMode || deleteConfirmation ? 'pointer-events-none opacity-50' : ''}`}>
            <button
              ...
              className="flex items-center justify-center gap-2 bg-gruvbox-purple hover:bg-gruvbox-purple px-3 py-2 rounded text-sm"
              title="Save Project"
            >
              <Download size={16} />
              <span className="text-xs">Save</span>
            </button>
            <label className="flex items-center justify-center gap-2 bg-gruvbox-purple hover:bg-gruvbox-purple px-3 py-2 rounded cursor-pointer text-sm"
              title="Load Project">
              <ImagePlus size={16} />
          ...
          <div className="h-6 w-px bg-gruvbox-bg4"></div>

          <div className={`flex items-center gap-2 ${cropMode || deleteConfirmation ? 'pointer-events-none opacity-50' : ''}`}>
            <button
              onClick={pasteFromClipboard}
              className="flex items-center justify-center gap-2 bg-gruvbox-orange hover:bg-gruvbox-orange px-3 py-2 rounded text-sm"
              title="Paste from Clipboard"
            >
              <ClipboardPaste size={18} />
            </button>
            <label className="flex items-center justify-center gap-2 bg-gruvbox-blue hover:bg-gruvbox-blue px-3 py-2 rounded cursor-pointer text-sm"
              title="Add Image">
              <ImagePlus size={18} />
            ...
            <button
              onClick={addText}
              className="flex items-center justify-center gap-2 bg-gruvbox-green hover:bg-gruvbox-green px-3 py-2 rounded text-sm"
              title="Add Text"
            >
              <Type size={18} />
            </button>
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-gruvbox-red hover:bg-gruvbox-red px-3 py-2 rounded text-sm"
          ...
          <div className={`flex items-center gap-4 flex-1 ${cropMode || deleteConfirmation ? 'pointer-events-none opacity-50' : ''}`}>
            <div className="flex items-center gap-2">
              <button
                ...
                className="p-2 bg-gruvbox-bg3 hover:opacity-80 rounded"
                title="Zoom Out"
              >
                <ZoomOut size={18} />
              </button>
              ...
              <button
                onClick={() => setZoom(1)}
                className="px-3 py-2 bg-gruvbox-bg3 hover:opacity-80 rounded text-sm"
                title="Reset Zoom"
              >
                Reset Zoom
              </button>
          ...
          {cropMode && (
            <div className="flex items-center gap-2">
              <span className="text-sm text-gruvbox-fg mr-2">Hold <strong>Shift</strong> to maintain ratio</span>
              <button
                onClick={applyCrop}
                className="flex items-center gap-2 px-4 py-2 bg-gruvbox-green hover:bg-gruvbox-green rounded text-sm font-medium"
              >
                <Check size={18} />
                Apply Crop
              </button>
              <button
                onClick={cancelCrop}
                className="flex items-center gap-2 px-4 py-2 bg-gruvbox-red hover:bg-gruvbox-red rounded text-sm font-medium"
              >
                <X size={18} />
                Cancel
              </button>
          ...
          {deleteConfirmation && (
            <div className="flex items-center gap-2">
              <span className="text-sm text-gruvbox-fg mr-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gruvbox-bg4 hover:brightness-110 rounded text-sm font-medium"
              >
                <X size={18} />
                Cancel
              </button>
        ...
        <div className="flex-1 flex items-center justify-center p-8 overflow-auto" onMouseDown={(e) => {
          ...
          <div className="relative" style={{ transform: `scale(${zoom})`, transformOrigin: 'center' }}>
            <canvas
              ...
              className={`border border-gruvbox-bg4 shadow-2xl ${deleteConfirmation ? 'pointer-events-none opacity-50' : 'cursor-crosshair'}`}
            />
          </div>
        </div>
      </div>
      ...
      {selectedLayerData && selectedLayers.length === 0 ? (
        <div className="w-80 bg-gruvbox-bg2 overflow-y-auto relative">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gruvbox-bg3 px-2 py-1 rounded text-sm"
                />
              </div>
              <div>
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-2 gap-2 mb-2">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-3 py-2 bg-gruvbox-bg3 hover:opacity-80 rounded text-sm"
                  >
                ...
                {!cropMode && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-gruvbox-purple hover:bg-gruvbox-purple rounded text-sm"
                  >
                    <Crop size={16} />
                    Start Crop
                  </button>
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <button
                    ...
                    className="p-1 bg-gruvbox-bg3 hover:opacity-80 rounded"
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      onClick={rotateLayer}
                      className="px-2 py-1 bg-gruvbox-bg3 hover:opacity-80 rounded text-xs font-semibold"
                      title="Rotate 90°"
                    >
                      90°
                    </button>
            ...
            <>
              <div className="mb-3">
                ...
                <textarea
                  ...
                  className="w-full bg-gruvbox-bg3 px-2 py-1 rounded resize-none"
                  rows="3"
                />
              </div>

              <div className="mb-3 grid grid-cols-3 gap-2">
                <label className="flex items-center justify-center gap-1 cursor-pointer bg-gruvbox-bg3 hover:opacity-80 px-2 py-2 rounded">
                  <input
                    type="checkbox"
                    ...
                    className="hidden"
                  />
                  <span className={`text-lg font-bold ${selectedLayerData.bold ? 'text-blue-400' : 'text-gruvbox-fg'}`}>B</span>
                </label>
                <label className="flex items-center justify-center gap-1 cursor-pointer bg-gruvbox-bg3 hover:opacity-80 px-2 py-2 rounded">
                  <input
                    type="checkbox"
                    ...
                    className="hidden"
                  />
                  <span className={`text-lg italic font-serif ${selectedLayerData.italic ? 'text-blue-400' : 'text-gruvbox-fg'}`}>I</span>
                </label>
                <label className="flex items-center justify-center gap-1 cursor-pointer bg-gruvbox-bg3 hover:opacity-80 px-2 py-2 rounded">
                  <input
                    type="checkbox"
                    ...
                    className="hidden"
                  />
                  <span className={`text-lg underline ${selectedLayerData.underline ? 'text-blue-400' : 'text-gruvbox-fg'}`}>U</span>
                </label>
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="w-full bg-gruvbox-bg3 px-2 py-1 rounded"
                />
              </div>
              <div className="mb-3">
              ...
              {selectedLayerData.textEffect === 'none' || !selectedLayerData.textEffect ? (
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="w-full h-8 bg-gruvbox-bg3 rounded cursor-pointer"
                  />
                </div>
              ) : (
                <>
        ...
        <div className="w-80 bg-gruvbox-bg2 p-4 overflow-y-auto">
        ...
        <div className={`w-80 bg-gruvbox-bg2 p-4 overflow-y-auto ${cropMode || deleteConfirmation ? 'pointer-events-none opacity-50' : ''}`}>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-end gap-2">
              ...
              <button
                ...
                className="p-2 bg-gruvbox-purple hover:bg-gruvbox-purple rounded"
              ...
              {canvasSettings.bgImage ? (
                <div className="space-y-2">
                  <button
                    ...
                    className="w-full px-3 py-2 bg-gruvbox-red hover:bg-gruvbox-red rounded text-sm"
                  >
                    Remove Background Image
                  </button>
                </div>
              ) : (
                <label className="flex items-center justify-center gap-2 bg-gruvbox-bg3 hover:opacity-80 px-3 py-2 rounded cursor-pointer text-sm">
                  <ImagePlus size={16} />
                  Upload Image
            ...
            {canvasSettings.bgImage && (
              <>
                <div className="border-t border-gruvbox-bg4 pt-3 mt-3">
                ...
                <>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-6 bg-gruvbox-bg3 rounded cursor-pointer"
                    />
                  </div>
                </>
              )}
            ...
            <div className="border-t border-gruvbox-bg4 pt-3 mt-3">
              <button
                onClick={clearAll}
                className="w-full px-3 py-2 bg-gruvbox-red hover:bg-gruvbox-red rounded text-sm font-medium"
              >
                Clear All
              </button>
              <p className="text-xs text-gruvbox-gray mt-1 text-center">Remove all layers and reset canvas</p>
            </div>
          </div>
        </div>
      )}
